...
#     user_vector = tfidf_vectorizer.transform([user_input]).toarray()[0]
#
#     max_similarity = -1
#     recommended_fanfic = None
#
#     for fanfic in fanfics:
#         similarity = cosine_similarity([user_vector], [fanfic.vector])[0][0]
#         if similarity > max_similarity:
#             max_similarity = similarity
#             recommended_fanfic = fanfic
#
#     response_text = f"User: {user_input}\nAI: Based on your interest, here are some fanfiction recommendations:\n"
#     response_text += f"- {recommended_fanfic['Title']} by {recommended_fanfic['Author']} ({recommended_fanfic['Url']}): {recommended_fanfic['Summary']}\n"
#
#     return response_text, recommended_fanfic